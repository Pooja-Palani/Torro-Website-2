  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] pb-20 pt-[calc(var(--header-height)+2rem)]">
      <div className="container mx-auto px-6">
        {/* Back Button */}
        <Link to="/" className="inline-flex items-center gap-2 text-[12px] font-black text-slate-400 uppercase tracking-widest hover:text-[#99A0F9] transition-colors mb-12">
