...
const ArticleCard = ({ title, excerpt, category, index }) => (
    ...
    >
        <div className="flex items-center justify-between mb-8">
            <span className="text-[11px] font-bold text-blue-600 uppercase tracking-widest">{category}</span>
            ...
            <div className="container">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
                    <div className="max-w-xl space-y-4">
                        <span className="text-sm font-bold text-blue-600 uppercase tracking-widest block">
                            Intelligence
                        </span>
