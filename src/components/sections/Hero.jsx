                    ...
                    <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end mt-12 lg:mt-0">
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="absolute left-[30%] top-[30%] -translate-x-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-[#1e1a38]/90 border border-primary/40 flex items-center justify-center backdrop-blur-md shadow-[0_0_20px_rgba(153,160,249,0.3)] z-30"
                            >
                            ...
                            <motion.div
                                ...
                                className="absolute left-[70%] top-[70%] -translate-x-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-[#1e1a38]/90 border border-primary/40 flex items-center justify-center backdrop-blur-md shadow-[0_0_20px_rgba(153,160,249,0.3)] z-30"
                            >
                            ...
                            <motion.div
                                ...
                                className="absolute left-[76%] top-[24%] -translate-x-1/2 -translate-y-1/2 w-16 h-16 rounded-full bg-[#1e1a38]/90 border border-primary/40 flex items-center justify-center backdrop-blur-md shadow-[0_0_20px_rgba(153,160,249,0.3)] z-30"
                            >
                            ...
                            <motion.div
                                ...
                                className="absolute left-[96%] top-[50%] -translate-x-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-[#1e1a38]/90 border border-primary/40 flex items-center justify-center backdrop-blur-md shadow-[0_0_20px_rgba(153,160,249,0.3)] z-30"
                            >
                            ...
                            <motion.div
                                ...
                                className="absolute left-[4%] top-[50%] -translate-x-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-[#1e1a38]/90 border border-primary/40 flex items-center justify-center backdrop-blur-md shadow-[0_0_20px_rgba(153,160,249,0.3)] z-30"
                            >
                            ...
                            <div className="relative z-20 mb-[20px] translate-y-8 group-hover:translate-y-2 transition-transform duration-700">
                                <div className="absolute inset-0 bg-[#99A0F9]/30 blur-3xl rounded-full" />
                                <Shield className="w-72 h-72 text-primary drop-shadow-[0_0_40px_rgba(153,160,249,0.5)] z-10 relative stroke-[1]" />
                                {/* Static Lock */}
                            ...
                            <div className="relative z-10 w-full max-w-[480px] mt-8 group h-[160px]">
                                ...
                                <div className="absolute top-[80px] inset-x-8 h-[70px] bg-primary/10 blur-[30px] rounded-[100%] z-0" />

                                {/* Bottom Base Curve (Lower Ellipse) */}
                                <div className="absolute top-[50px] inset-x-0 h-[100px] bg-gradient-to-b from-[#131024] to-[#05040a] rounded-[100%] border-b border-primary/10 shadow-[0_40px_60px_rgba(0,0,0,0.95)] z-10" />

                                {/* Middle Bridge (Cylinder Body) */}
                                <div className="absolute top-[50px] inset-x-0 h-[50px] bg-gradient-to-b from-[#18142e] to-[#0a0715] border-x border-primary/10 z-10 flex items-center justify-center">
                                ...
                                <div className="absolute top-0 inset-x-0 h-[100px] bg-gradient-to-b from-[#251e40] to-[#120e24] rounded-[100%] border border-primary/20 z-20 shadow-[inset_0_2px_15px_rgba(153,160,249,0.05)] flex items-center justify-center overflow-hidden">
                                    ...
                                    <div className="absolute w-[60%] h-[60%] bg-gradient-to-r from-primary/15 to-accent/15 blur-[25px] rounded-[100%]" />
                                </div>
                            </div>
