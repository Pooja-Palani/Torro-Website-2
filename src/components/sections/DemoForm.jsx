                                    ...
                                    >
                                        <div className="grid md:grid-cols-2 gap-6">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <input type="email" required className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-[14px] text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all shadow-sm" placeholder="ciso@company.com" />
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <select className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-[14px] text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all appearance-none cursor-pointer shadow-sm">
                                ...
                                {!newsletterSubmitted ? (
                                    <form onSubmit={(e) => { e.preventDefault(); setNewsletterSubmitted(true); }} className="relative">
                                        <input 
                                            ...
                                            className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-[14px] focus:outline-none focus:ring-1 focus:ring-indigo-400 focus:bg-white/10 transition-all pr-12"
                                        />
                                        <button type="submit" className="absolute right-1 top-1 bottom-1 w-10 flex items-center justify-center bg-indigo-500 hover:bg-indigo-400 rounded-lg transition-colors group">
